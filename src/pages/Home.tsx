        ...
        <div className={"h-full flex flex-col justify-between w-full overflow-y-scroll scroll-smooth no-scrollbar"}>
            ...
            <div className={"flex flex-col xl:flex-row justify-between w-full xl:items-end"}>
                ...
                <div className={"flex flex-col items-end justify-end gap-[10px]"}>
                    <div className={"flex flex-row items-center justify-end gap-[10px] w-full xl:w-auto"}>
                        <button
                            className={"w-[50%] xl:px-14 xl:w-auto py-[12px] bg-[#714DD7] text-white font-normal font-poppins text-[24px] xl:text-[40px] hover:bg-[#6041BA] transition duration-300 cursor-pointer"}
                            onClick={() => {
                                setPage("skills")
                            }}
                        >
                        ...
                        <button
                            className={"w-[55%] xl:w-auto xl:px-14 py-[12px] bg-[#714DD7] text-white font-normal font-poppins text-[24px] xl:text-[40px] hover:bg-[#6041BA] transition duration-300 cursor-pointer"}
                            onClick={() => {
                                setPage("about")
                            }}
                        >
                    ...
                    <button
                        className={"px-14 py-[12px] w-full bg-[#1A1A1A] text-white font-normal font-poppins text-[24px] xl:text-[40px] hover:bg-[#121212] transition duration-300 cursor-pointer"}
                        onClick={() => {
                            setPage("contact")
                        }}
                    >
        ...
        <div className={"w-full h-[100vh] bg-[#090909] flex items-center justify-center overflow-y-hidden"}>
            ...
            >
                ...
                {showedBackground && (
                    // Content
                    <motion.div
                        className={"absolute w-[90%] h-[80%] self-center bg-[#121212]/50 flex flex-col items-start justify-between p-[60px] xl:p-[80px] backdrop-blur-[20px]"}
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
