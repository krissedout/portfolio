        ...
        <div className={"h-full flex flex-col justify-between w-full overflow-y-scroll scroll-smooth no-scrollbar"}>
            ...
            <div className={"flex flex-col xl:flex-row justify-between w-full xl:items-end gap-8"}>
                ...
                <div className={"flex flex-col items-end justify-end gap-2.5"}>
                    <div className={"flex flex-row gap-2.5 w-full xl:w-auto"}>
                        <button
                            className={"flex-1 xl:flex-none xl:px-14 py-3 bg-[#714DD7] text-white font-normal font-poppins text-[24px] xl:text-[40px] hover:bg-[#6041BA] transition duration-300 cursor-pointer whitespace-nowrap"}
                            onClick={() => {
                                setPage("work")
                            }}
                        >
                    ...
                    <button
                        className={"px-14 py-3 w-full bg-[#1A1A1A] text-white font-normal font-poppins text-[24px] xl:text-[40px] hover:bg-[#121212] transition duration-300 cursor-pointer"}
                        onClick={() => {
                            setPage("contact")
                        }}
                    >
    ...
    return (
        <div className={"w-full h-screen-fixed bg-[#090909] flex items-center justify-center overflow-y-hidden"}>
            ...
            >
                ...
                {loaded && (
                    <motion.div
                        className={"overflow-hidden absolute object-cover object-center inset-0"}
                        initial={{ 
                ...
                {showedBackground && (
                    /*Paper clip - split into base (behind) and line (in front)*/
                    <>
                        {/*Clip base - behind the page*/}
                        <div className={"absolute top-[5%] right-[2%] pointer-events-none z-10"}>
                        ...
                        {/*Line over the content - in front*/}
                        {firstClipPathDone && (
