...
const AppleHelloEnglishEffect = forwardRef<SVGSVGElement, Props>(
    ({ className, speed = 1, onAnimationComplete, ...props }, ref) => {
        ...
        const initial = prefersReduced ? animateProps : initialProps;
        const zeroOr = (v: number) => (prefersReduced ? 0 : v);
        ...
        return (
            <motion.svg
                ...
                initial={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                transition={{ duration: zeroOr(0.5) }}
                {...props}
            >
                <title>hello</title>
                ...
                <motion.path
                    ...
                    transition={{
                        duration: zeroOr(calc(0.8)),
                        ease: "easeInOut",
                        opacity: { duration: zeroOr(0.4) },
                    }}
                />
                ...
                <motion.path
                    ...
                    animate={animateProps}
                    transition={{
                        duration: zeroOr(calc(2.8)),
                        ease: "easeInOut",
                        delay: zeroOr(calc(0.7)),
                        opacity: { duration: zeroOr(0.7), delay: zeroOr(calc(0.7)) },
                    }}
...
AppleHelloEnglishEffect.displayName = "AppleHelloEnglishEffect";
